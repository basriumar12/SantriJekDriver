...
public class DBHandler extends SQLiteOpenHelper {
    ...
    public static String TABLE_STORE_BELANJA = "STORE_BELANJA";
    public static String TABLE_LAUNDRY_BELANJA = "LAUNDRY_BELANJA";
    ...
    public static String COLUMN_CATATAN_BARANG = "CATATAN_BARANG";
    public static String COLUMN_IS_CHECKED = "IS_CHECKED";
    public static String COLUMN_NAMA_TOKO = "NAMA_TOKO";

    public static String COLUMN_NAMA_LAUNDRY = "NAMA_LAUNDRY";

    public static String COLUMN_ID_ITEM_LAUNDRY = "ID_ITEM_LAUNDRY";
    public static String COLUMN_NAMA_MENU = "NAMA_MENU";
    public static String COLUMN_JUMLAH_LAUNDRY = "JUMLAH_LAUNDRY";
    public static String COLUMN_HARGA_LAUNDRY = "HARGA_LAUNDRY";
    public static String COLUMN_FOTO_LAUNDRY = "FOTO_LAUNDRY";
    public static String COLUMN_CATATAN_LAUNDRY = "CATATAN_LAUNDRY";
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        db.execSQL("CREATE TABLE IF NOT EXISTS " + TABLE_RIWAYAT_TRANSAKSI + " ("
                ...
                + COLUMN_ALAMAT_ASAL + " VARCHAR NOT NULL, "
                + COLUMN_ALAMAT_TUJUAN + " VARCHAR NOT NULL, "
                + COLUMN_DEBIT + " INTEGER NOT NULL, "
                + COLUMN_KREDIT + " INTEGER NOT NULL, "
                + COLUMN_SALDO + " INTEGER NOT NULL, "
                + COLUMN_BIAYA_AKHIR + " INTEGER NOT NULL, "
        ...
        db.execSQL("CREATE TABLE IF NOT EXISTS " + TABLE_STORE_BELANJA + " ("
                + COLUMN_ID_BARANG + " VARCHAR, "
                + COLUMN_NAMA_BARANG + " VARCHAR NOT NULL, "
                + COLUMN_JUMLAH_BARANG + " VARCHAR NOT NULL, "
                + COLUMN_HARGA_BARANG + " VARCHAR, "
                + COLUMN_FOTO_BARANG + " VARCHAR, "
                + COLUMN_CATATAN_BARANG + " VARCHAR)");

        db.execSQL("CREATE TABLE IF NOT EXISTS " + TABLE_LAUNDRY_BELANJA + " ("
                + COLUMN_ID_ITEM_LAUNDRY + " VARCHAR, "
                + COLUMN_NAMA_MENU + " VARCHAR NOT NULL, "
                + COLUMN_JUMLAH_LAUNDRY + " VARCHAR NOT NULL, "
                + COLUMN_HARGA_LAUNDRY + " VARCHAR, "
                + COLUMN_FOTO_LAUNDRY + " VARCHAR, "
                + COLUMN_CATATAN_LAUNDRY + " VARCHAR)");
    ...
    public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
        ...
        db.execSQL("CREATE TABLE IF NOT EXISTS " + TABLE_RIWAYAT_TRANSAKSI + " ("
                ...
                + COLUMN_SALDO + " INTEGER NOT NULL, "
                + COLUMN_BIAYA_AKHIR + " INTEGER NOT NULL, "
                + COLUMN_ALAMAT_ASAL + " INTEGER NOT NULL, "
                + COLUMN_ALAMAT_TUJUAN + " INTEGER NOT NULL, "
                + COLUMN_TIPE_TRANSAKSI + " VARCHAR NOT NULL, "
                + COLUMN_ID_FITUR + " VARCHAR NOT NULL, "
                + COLUMN_FITUR + " VARCHAR NOT NULL, "
                + COLUMN_KETERANGAN + " VARCHAR NOT NULL)");
