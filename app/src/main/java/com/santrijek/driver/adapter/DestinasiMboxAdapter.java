...
public class DestinasiMboxAdapter extends RecyclerView.Adapter<DestinasiMboxAdapter.MyViewHolder> {
    ...
    public void onBindViewHolder(MyViewHolder holder, int position) {
        holder.urutanPenerima.setText("Destination "+String.valueOf(position+1));
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder{
        ...
        public MyViewHolder(View itemView){
            ...
            btnrute = (Button) itemView.findViewById(R.id.rute);
            ...
            btnrute.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    onItemTouchListener.onButton2Click(view, getLayoutPosition());
                }
            });
