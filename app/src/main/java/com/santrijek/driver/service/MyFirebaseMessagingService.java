...
import com.santrijek.driver.activity.NotificationActivity;
...
public class MyFirebaseMessagingService extends FirebaseMessagingService {
   ...
   private static final String TAG = "MyFMService";
    public static final String BROADCAST_ACTION = "driver.pacekurir.kendari";
...
//                    transaksi.shipper = remMsg.get("shipper");
    ...
    private void intentToChat(Bundle bundle){
        ...
        if(!isForeground("driver.pacekurir.kendari.activity.ChatActivity")){
